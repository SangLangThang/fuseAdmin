...
export class ChatService {
    ...
    private _chatClient: BehaviorSubject<StreamChat<DefaultGenerics>> =
        new BehaviorSubject(null);
    private _chatUsers: BehaviorSubject<Array<UserResponse<DefaultGenerics>>> =
        new BehaviorSubject(null);
    /**
     * Constructor
     */
    ...
    get chatClient$(): Observable<StreamChat<DefaultGenerics>> {
        return this._chatClient.asObservable();
    }
